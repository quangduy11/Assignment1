<%-- 
    ...
    Created on : Mar 18, 2024, 11:56:01 PM
    Author     : Admin
--%>
...
<script>
                            function validateForm2() {
                                ...
                                if (name === '') {
                                    $('#nameEditError').html('Name is not empty !');
                                }

                                if (price === '') {
                                    $('#priceEditError').html('Price is not empty !');
                                } else if (!$.isNumeric(price) || parseFloat(price) < 0) {
                                    $('#priceEditError').html('Price is not character alphabet and is more than 0 !');
                            }

                                if (quantity === '') {
                                $('#quantityEditError').html('Quantity is not empty !');
                                    } else if (!$.isNumeric(quantity) || parseInt(price) < 0) {                                     $('#priceEditError').html('Số lượng của quyển sách phải là số và không được nhỏ hơn 0');
                                }
